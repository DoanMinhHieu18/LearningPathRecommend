class Course:
    def __init__(self, course_id, course_name, major_id, prerequisite, semester, count_learner, average_score, credit, is_course, is_group_c, is_group_d):
    ...
    def __repr__(self):
        return (f"Course(course_id={self.course_id}, course_name='{self.course_name}', major_id={self.major_id}, "
                ...
                f"average_score={self.average_score}, credit={self.credit}, is_course={self.is_course}, is_group_c={self.is_group_c}, is_group_d={self.is_group_d})")